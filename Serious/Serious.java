...
//        // 버튼 배경색
//        for (int i=0; i<10; i++) {
//            num_btn[i].setBackground(Color.RED);
//            num_btn[i].setOpaque(true);
//            num_btn[i].setBorderPainted(false);
//            num_btn[i].setContentAreaFilled(false);
//            num_btn[i].setFocusPainted(false);
//        }
